<?php
/*
 * File name: BusinessCategoryControllerTest.php
...
class BusinessCategoryControllerTest extends TestCase
{
    ...
    public function testIndex()
    {
        ...
        $response->assertSeeTextInOrder([__('lang.business_category_desc'), __('lang.business_category_table'), __('lang.business_category_create')]);
    }
    ...
    public function testCreate()
    {
        ...
        $response->assertStatus(200);
        $response->assertSeeTextInOrder([__('lang.business_category_desc'), __('lang.business_category_name'), __('lang.business_category_commission')]);
    }
    ...
    public function testStore()
    {
        ...
        $response->assertSessionHas('flash_notification.0.message', __('lang.saved_successfully', ['operator' => __('lang.business_category')]));
    }
    ...
    public function testUpdate()
    {
        ...
        $response->assertSessionHas('flash_notification.0.level', 'success');
        $response->assertSessionHas('flash_notification.0.message', __('lang.updated_successfully', ['operator' => __('lang.business_category')]));
    }
    ...
    public function testDestroy()
    {
        ...
        $response->assertSessionHas('flash_notification.0.level', 'success');
        $response->assertSessionHas('flash_notification.0.message', __('lang.deleted_successfully', ['operator' => __('lang.business_category')]));
    }
