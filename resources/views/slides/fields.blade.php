...
<!-- Image Fit Field -->
    ...
    <!-- Article Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('article_id', trans("lang.slide_article_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('article_id', $article, null, ['data-empty'=>trans("lang.slide_article_id_placeholder"), 'class' => 'select2 not-required form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.slide_article_id_help") }}</div>
        </div>
    </div>

    <!-- Business Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('business_id', trans("lang.slide_business_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('business_id', $business, null, ['data-empty'=>trans("lang.slide_business_id_placeholder"), 'class' => 'select2 not-required form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.slide_business_id_help") }}</div>
        </div>
    </div>
