...
<!-- E Provider Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('business_id', trans("lang.gallery_business_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('business_id', $salon, null, ['class' => 'select2 form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.gallery_business_id_help") }}</div>
        </div>
    </div>
...
<div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
    <div class="d-flex flex-row justify-content-between align-items-center">
        {!! Form::label('status', trans("lang.gallery_status_help"),['class' => 'control-label my-0 mx-3'],false) !!} {!! Form::hidden('status', 0, ['id'=>"hidden_featured"]) !!}
