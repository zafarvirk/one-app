...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::select('business_id', $market, null, ['class' => 'select2 form-control']) !!}
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::select('article_categories[]', $category, null, ['class' => 'select2 form-control','multiple'=>'multiple']) !!}
