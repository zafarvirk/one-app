...
@can('classManager.dashboard')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('classManager.dashboard*') ? 'active' : '' }}" href="{!! url('classManager/dashboard') !!}">@if($icons)
                <i class="nav-icon fas fa-tachometer-alt"></i>@endif
            <p>{{trans('lang.dashboard')}}</p></a>
    </li>
@endcan
...
{{-- @can('salons.index') --}}
    <li class="nav-item has-treeview {{ (Request::is('salon*') || Request::is('requestedSalons*') || Request::is('markets*') || Request::is('gyms*') || Request::is('galleries*') || Request::is('businessReviews*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('availabilityHours*') ) && !Request::is('salonPayouts*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ (Request::is('salon*') || Request::is('requestedSalons*') || Request::is('markets*') || Request::is('gyms*') || Request::is('galleries*') || Request::is('businessReviews*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('availabilityHours*')) && !Request::is('salonPayouts*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fas fa-users-cog"></i>@endif
            <p>{{trans('lang.businesses_plural')}} <i class="right fas fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('businessCategories.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('businessCategories*') ? 'active' : '' }}" href="{!! route('businessCategories.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-list-alt"></i>@endif<p>{{trans('lang.business_category_plural')}}</p></a>
                </li>
            @endcan
            ...
            @can('markets.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('markets*') ? 'active' : '' }}" href="{!! route('markets.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-list-alt"></i>@endif<p>{{trans('lang.market_plural')}}</p></a>
                </li>
            @endcan
            @can('gyms.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('gyms*') ? 'active' : '' }}" href="{!! route('gyms.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-list-alt"></i>@endif<p>{{trans('lang.gym_plural')}}</p></a>
                </li>
            @endcan
            @can('businessReviews.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('businessReviews*') ? 'active' : '' }}" href="{!! route('businessReviews.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-comments"></i>@endif<p>{{trans('lang.business_review_plural')}}</p></a>
                </li>
            @endcan
            @can('galleries.index')
                <li class="nav-item">
            ...
            @can('aminities.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('aminities*') ? 'active' : '' }}" href="{!! route('aminities.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-map-marked-alt"></i>@endif<p>{{trans('lang.aminities_plural')}}</p></a>
                </li>
            @endcan
            @can('highlights.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('highlights*') ? 'active' : '' }}" href="{!! route('highlights.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-map-marked-alt"></i>@endif<p>{{trans('lang.highlights_plural')}}</p></a>
                </li>
            @endcan
            @can('features.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('features*') ? 'active' : '' }}" href="{!! route('features.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-map-marked-alt"></i>@endif<p>{{trans('lang.features_plural')}}</p></a>
                </li>
            @endcan
            @can('plans.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('plans*') ? 'active' : '' }}" href="{!! route('plans.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-map-marked-alt"></i>@endif<p>{{trans('lang.plans_plural')}}</p></a>
                </li>
            @endcan
            @can('modules.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('modules*') ? 'active' : '' }}" href="{!! route('modules.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-map-marked-alt"></i>@endif<p>{{trans('lang.modules_plural')}}</p></a>
                </li>
            @endcan
        </ul>
    </li>
{{-- @endcan --}}
{{-- @can('markets.index')
    <li class="nav-item has-treeview {{ (Request::is('markets*')) ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ (Request::is('markets*')) ? 'active' : '' }}"> @if($icons)
...
{{-- @can('article.index') --}}
    <li class="nav-item has-treeview {{ Request::is('article_categories*') || Request::is('article*') || Request::is('products*') || Request::is('class_article*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('nutrition*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('article_categories*') || Request::is('article*') || Request::is('products*') || Request::is('class_article*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('nutrition*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fas fa-pencil-ruler"></i>@endif
            <p>{{trans('lang.article_plural_1')}} <i class="right fas fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('article_categories.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('article_categories*') ? 'active' : '' }}" href="{!! route('article_categories.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-folder-open"></i>@endif<p>{{trans('lang.category_plural')}}</p></a>
                </li>
            @endcan
            @can('article.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('article*') ? 'active' : '' }}" href="{!! route('article.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-list"></i>@endif
                        <p>{{trans('lang.article_table')}}</p></a>
                </li>
            @endcan
            @can('products.index')
                <li class="nav-item">
            ...
            @can('class_article.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('class_article*') ? 'active' : '' }}" href="{!! route('class_article.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-archive"></i>@endif
                        <p>{{trans('lang.class_article_plural')}}</p></a>
                </li>
            @endcan
            ...
            @endcan
            @can('article_schedule.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('article_schedule*') ? 'active' : '' }}" href="{!! route('article_schedule.index') !!}">@if($icons)
                            <i class="nav-icon far fa-plus-square"></i>@endif<p>{{trans('lang.article_schedule')}}</p></a>
                </li>
            @endcan
...
@can('requests.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('requests*') ? 'active' : '' }}" href="{!! route('requests.index') !!}">@if($icons)
                <i class="nav-icon fas fa-ticket-alt"></i>@endif<p>{{trans('lang.request_plural')}} </p></a>
    </li>
@endcan

@can('bookings.index')
<li class="nav-item has-treeview {{ Request::is('bookings*') || Request::is('orders*') || Request::is('transactionStatuses*') || Request::is('deliveryAddresses*')? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('bookings*') || Request::is('orders*') || Request::is('transactionStatuses*') || Request::is('deliveryAddresses*')? 'active' : '' }}"> @if($icons)
    ...
    <ul class="nav nav-treeview">
        ...
        @can('orders.index')
            ...
            @endcan
        @can('transactionStatuses.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('transactionStatuses*') ? 'active' : '' }}" href="{!! route('transactionStatuses.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-server"></i>@endif<p>{{trans('lang.transaction_status_plural')}}</p></a>
            </li>
        @endcan
            ...
            @can('salonPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('salonPayouts*') ? 'active' : '' }}" href="{!! route('salonPayouts.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-money-bill-wave"></i>@endif<p>{{trans('lang.salon_payout_plural')}}</p></a>
                </li>
            @endcan
        ...
        <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
                <a href="{!! url('settings/mobile/home') !!}" class="nav-link {{  Request::is('settings/mobile/home*') ? 'active' : '' }}">
                    @if($icons)<i class="nav-icon fas fa-cog"></i> @endif <p>{{trans('lang.app_setting_home')}}
                    </p>
                </a>
            </li>
