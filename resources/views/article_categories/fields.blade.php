        ...
        <script type="text/javascript">
            ...
            var dz_var16110650672130312723ble = $(".dropzone.image").dropzone({
                ...
                removedfile: function (file) {
                    dzRemoveFile(
                        file, var16110650672130312723ble, '{!! url("article_categories/remove-media") !!}',
...
<div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
    ...
    <a href="{!! route('article_categories.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
