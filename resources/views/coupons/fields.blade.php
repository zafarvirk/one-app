...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <!-- article Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('articles[]', trans("lang.coupon_article_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('articles[]', $articles, $articlesSelected, ['class' => 'select2 form-control', 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.coupon_article_id_help") }}</div>
        </div>
    </div>

    <!-- Business Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('business[]', trans("lang.coupon_business_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('business[]', $business, $businessesSelected, ['class' => 'select2 form-control', 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.coupon_business_id_help") }}</div>
        </div>
    </div>

    <!-- Category Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('articleCategories[]', trans("lang.coupon_articleCategory_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('articleCategories[]', $articleCategory, $articleCategoriesSelected, ['class' => 'select2 form-control', 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.coupon_articleCategory_id_help") }}</div>
        </div>
    </div>
