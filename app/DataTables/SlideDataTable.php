...
class SlideDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('article.name', function ($slide) {
                return getLinksColumnByRouteName([$slide->article], 'article.edit', 'id', 'name');
            })
            ->editColumn('business.name', function ($slide) {
                return getLinksColumnByRouteName([$slide->business], 'businesses.edit', 'id', 'name');
            })
    ...
    {
        return $model->newQuery()->with("article")->with("business")->select("$model->table.*");
    }
