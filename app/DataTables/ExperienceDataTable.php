...
class ExperienceDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('business.name', function ($experience) {
                return getLinksColumnByRouteName([$experience->business], 'businesses.edit', 'id', 'name');
            })
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'business.name',
                'title' => trans('lang.experience_business_id'),
    ...
    public function query(Experience $model)
    {
        if (auth()->user()->hasRole('salon owner')) {
            return $model->newQuery()->with("business")->join('business_users', 'business_users.business_id', '=', 'experiences.business_id')
