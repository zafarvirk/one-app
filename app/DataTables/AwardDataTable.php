...
class AwardDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('business.name', function ($award) {
                return getLinksColumnByRouteName([$award->business], 'businesses.edit', 'id', 'name');
            })
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'business.name',
                'title' => trans('lang.award_business_id'),
    ...
    public function query(Award $model)
    {
        if (auth()->user()->hasRole('salon owner')) {
            return $model->newQuery()->with("business")->join('business_users', 'business_users.business_id', '=', 'awards.business_id')
                ->groupBy('awards.id')
                ->select('awards.*')
            ...
            return $model->newQuery()->with("business")->select('awards.*');
        }
    }
