<?php
/*
 * File name: ArticleCategoriesDataTable.php
...
class ArticleCategoriesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('parent_category.name', function ($category) {
                return getLinksColumnByRouteName([$category->parentCategory], 'article_categories.edit', 'id', 'name');
            })
            ->editColumn('updated_at', function ($category) {
                return getDateColumn($category, 'updated_at');
            })
            ->addColumn('action', 'article_categories.datatables_actions')
    ...
    protected function getColumns()
    {
        ...
        $hasCustomField = in_array(ArticleCategories::class, setting('custom_field_models', []));
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', ArticleCategories::class)->where('in_table', '=', true)->get();
     ...
     *
     * @param ArticleCategories $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ArticleCategories $model)
    {
        return $model->newQuery()->with("parentCategory")->select("article_categories.*");
    }
    ...
    {
        return 'articlecategoriessdatatable_' . time();
    }
}
