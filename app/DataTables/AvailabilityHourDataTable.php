...
class AvailabilityHourDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('business.name', function ($availabilityHour) {
                return getLinksColumnByRouteName([$availabilityHour->business], 'businesses.edit', 'id', 'name');
            })
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'business.name',
                'name' => 'business.name',
                'title' => trans('lang.availability_hour_business_id'),
    ...
    public function query(AvailabilityHour $model)
    {
        if (auth()->user()->hasRole('salon owner')) {
            return $model->newQuery()->with("business")->join('business_users', 'business_users.business_id', '=', 'availability_hours.business_id')
            ...
            return $model->newQuery()->with("business")->select('availability_hours.*');
        }
    }
