<?php
/*
 * File name: BusinessPayoutDataTable.php
...
class BusinessPayoutDataTable extends DataTable
{
    /**
    ...
    protected function getColumns()
    {
        ...
        $hasCustomField = in_array(BusinessPayout::class, setting('custom_field_models', []));
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', BusinessPayout::class)->where('in_table', '=', true)->get();
     ...
     *
     * @param BusinessPayout $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BusinessPayout $model)
    {
