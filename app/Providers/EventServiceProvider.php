...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        'App\Events\TransactionStatusChangedEvent' => [
            'App\Listeners\SendTransactionStatusNotificationsListener'
        ],
        'App\Events\BusinessChangedEvent' => [
            'App\Listeners\UpdateBusinessEarningTableListener',
            'App\Listeners\ChangeCustomerRoleToBusiness',
        ],
