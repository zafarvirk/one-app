...
class Order extends Model
{
    ...
    public static $rules = [
        ...
        'transaction_status_id' => 'required|exists:order_statuses,id',
    ...
    {
        return $this->belongsTo(\App\Models\TransactionStatus::class, 'transaction_status_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\ArticleOrder::class);
    }
    ...
    {
        return $this->belongsToMany(\App\Models\Article::class, 'article_orders');
    }
