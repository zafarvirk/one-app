...
use App\Casts\ArticleCollectionCast;
 ...
 * @property Business salon
 * @property Article[] e_services
...
class Booking extends Model
{
    ...
    protected $casts = [
        ...
        'article' => ArticleCollectionCast::class,
    ...
    public function getAtSalonAttribute(): bool
    {
        if($this->business->address){
            $this->address->id == $this->business->address->id;
        }
        return false;
    }
    ...
    public function getSubtotal(): float
    {
        ...
        foreach ($this->article as $article) {
            $total += $article->getPrice() * ($this->quantity >= 1 ? $this->quantity : 1);
        }
