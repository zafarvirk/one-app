...
class AwardController extends Controller
{
    ...
    public function __construct(AwardRepository $awardRepo, CustomFieldRepository $customFieldRepo, BusinessRepository $businessRepo)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        return view('awards.create')->with("customFields", isset($html) ? $html : false)->with("businesses", $business);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('awards.edit')->with('award', $award)->with("customFields", isset($html) ? $html : false)->with("businesses", $business);
    }
