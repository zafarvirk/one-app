...
class FavoriteController extends Controller
{
    ...
    public function __construct(FavoriteRepository $favoriteRepo, CustomFieldRepository $customFieldRepo, ArticleRepository $articleRepo
    ...
    {
        $article = $this->articleRepository->pluck('name', 'id');
        ...
        return view('favorites.create')->with("customFields", isset($html) ? $html : false)->with("article", $article)->with("option", $option)->with("optionsSelected", $optionsSelected)->with("user", $user);
    }
    ...
    public function edit($id)
    {
        ...
        return view('favorites.edit')->with('favorite', $favorite)->with("customFields", isset($html) ? $html : false)->with("article", $article)->with("option", $option)->with("optionsSelected", $optionsSelected)->with("user", $user);
    }
