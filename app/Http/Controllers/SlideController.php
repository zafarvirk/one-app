...
class SlideController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('slides.create')->with("customFields", isset($html) ? $html : false)->with("article", $article)->with("business", $business);
    }
    ...
    public function edit($id)
    {
        ...
        $article = $this->articleRepository->pluck('name', 'id')->prepend(__('lang.slide_e_service_id_placeholder'), '');
        $business = $this->businessRepository->pluck('name', 'id')->prepend(__('lang.slide_business_id_placeholder'), '');
        if (empty($slide)) {
        ...
        return view('slides.edit')->with('slide', $slide)->with("customFields", isset($html) ? $html : false)->with("article", $article)->with("business", $business);
    }
