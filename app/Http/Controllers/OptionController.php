...
class OptionController extends Controller
{
    ...
    public function create()
    {
        ...
        $article = $this->articleRepository->groupedBySalons();
        ...
        return view('options.create')->with("customFields", isset($html) ? $html : false)->with("article", $article)->with("optionGroup", $optionGroup);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('options.edit')->with('option', $option)->with("customFields", isset($html) ? $html : false)->with("article", $article)->with("optionGroup", $optionGroup);
    }
