...
class StatusChangedBooking extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject(trans('lang.notification_your_booking', ['booking_id' => $this->booking->id, 'transaction_status' => $this->booking->transactionStatus->status]) . " | " . setting('app_name', ''))
            ->greeting(trans('lang.notification_your_booking', ['booking_id' => $this->booking->id, 'transaction_status' => $this->booking->transactionStatus->status]))
    ...
    public function toFcm($notifiable): FcmMessage
    {
        ...
        $notification = [
            ...
            'body' => trans('lang.notification_your_booking', ['booking_id' => $this->booking->id, 'transaction_status' => $this->booking->transactionStatus->status]),
    ...
    {
        if ($this->booking->business->hasMedia('image')) {
            return $this->booking->business->getFirstMediaUrl('image', 'thumb');
        } else {
